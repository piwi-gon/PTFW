...
<div class="table" style="width:100%!important;margin-left:auto;margin-right:auto;">
    <div class="trow100">
        <div class="tcell100 tcellH40 ui-widget-header f12b" style="width:100%;vertical-align:middle;">
            Repositories
        </div>
    </div>
   <div class="trow100">
        <div class="tcell100" style="vertical-align:top;width:90%;">
            <div id="repositorytabsId">
                ...
                <div id="systemRepositoryId">
                    <div class="table100">
                        <div class="trow">
                            <div class="tcell" style="vertical-align:top;width:70%;">
...
?>
                            ...
                            <div class="tcell" style="width: 65%;vertical-align:top;text-align:left;">
                                <div id="repoContentId" style="width:90%;border:1px solid lightgrey;height:260px;overflow:auto;"></div>
                            </div>
                        </div>
                    </div>
                </div>
