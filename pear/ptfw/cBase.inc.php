...
class cBase {
    ...
    public function __call($method, $args) {
        ...
        if(array_key_exists($className, $_SESSION['_MOD'])) {
            ...
            /**
             * now check the module is activated
             * @var unknown
             */
            if($_SESSION['_MOD'][$className]['active'] == "true") {
                ...
                echo "Module not present or activated";
            }
        /**
...
abstract class BASE extends cBase {
    ...
    abstract public function baseRun();
}
...
abstract class BASESOAP extends \SoapServer {
    ...
    abstract public function baseSoapRun();
}
