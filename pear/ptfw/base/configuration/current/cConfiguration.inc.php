...
class cConfiguration extends BASE {
    ...
    public function getModuleHandler() {
        require_once(dirname(__FILE__) . DS . "modulehandler" . DS . "cModuleHandler.inc.php");
        $this->_moduleHandler = new cModuleHandler();
        if(is_object($this->_moduleHandler)) { return $this->_moduleHandler; }
        return null;
    }
